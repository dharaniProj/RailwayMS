...
async function migrate() {
  try {
    console.log('Starting Clean Migration: Salary Fix + Railway Pass Module...');
    ...
    // IMPORTANT: Make old columns nullable to avoid Not-Null constraint violations
    await pool.query('ALTER TABLE salary_history ALTER COLUMN month DROP NOT NULL;');
    await pool.query('ALTER TABLE salary_history ALTER COLUMN year DROP NOT NULL;');

    // Create unique constraint on the new column
    try {
